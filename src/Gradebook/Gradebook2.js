...
TabPanel.propTypes = {
 ...
 function Gradebook2() {
  ...
  const [deeleteCourseOn, setDeleteCourseOn] = React.useState(false);
  ...
  const handleCreate = () => {
    setCreateCourseOn(true)
    setDeleteCourseOn(false)
  }

  const handleDelete = () => {
    setCreateCourseOn(false)
    setDeleteCourseOn(true)
  }
