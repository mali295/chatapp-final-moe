            ...
            {this.props.grades.map((item, index) => {
                ...
                return (
                    <TableRow>
                      ...
                      <TableCell sx={{border:1, borderColor: 'black'}} >{item.sections}</TableCell>
                      <TableCell sx={{border:1, borderColor: 'black'}} >{item.tutorialGroups}</TableCell>
                      <TableCell sx={{border:1, borderColor: 'black'}} >{item.labGroups}</TableCell>
                    </TableRow>
