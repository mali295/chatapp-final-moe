...
import {
  getRequiredCourses
} from "../Gradebook/GradeBookEventSystem";
  ...
  return (
    ...
    <Button component={Link} to= "/Gradebook"  sx={{ my: 2, color: 'white', display: 'block' }}>
              ...
              <PopupState variant="popover" popupId="demo-popup-menu">
                {(popupState) => (
                  <React.Fragment>
                   ...
                   <Link to="/login"> <Button sx={{ my: 1, color: 'white' }}>chat</Button> </Link>
                    <Menu {...bindMenu(popupState)}>
                      <MenuItem
                        component={Link}
                        to="/Announcements"
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['WESTERN ', 'QUEENS ', 'WINDSOR ', 'MCMASTER '].map((text, index) => (
            <ListItemButton
              key={text}
              sx={{
                minHeight: 48,
            ...
            >
              ...
              >
                {index % 2 === 0 ? <SecurityIcon color='sidebarIcons'/> : <MailIcon color='sidebarIcons'/>}
              </ListItemIcon>
