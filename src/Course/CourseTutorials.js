...
export default function CourseTutorials( {match} ) {
  const {
    params: {courseID}
  } = match;
    ...
    <Box>
      ...
      {!isLoading && (
        <>
          ...
          <List>
            <ListItem>
              <Typography>{courseData.courseCode}: Tutorials</Typography>
            </ListItem>
            <ListItem>
            <CourseInstructorTable lectures={[]} tutorials={courseData.tutorialProfs} labs={[]}/>
            </ListItem>
