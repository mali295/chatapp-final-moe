    ...
    <Box>
      ...
      {!isLoading && (
        <>
          ...
          <List>
            <ListItem>
              <Typography>{courseData.courseCode}</Typography>
            </ListItem>
            <ListItem>
              <Typography>main prof: {courseData.prof}</Typography>
            </ListItem>
            <ListItem>
              <CourseInstructorTable lectures={courseData.sectionProfs} tutorials={courseData.tutorialProfs} labs={courseData.labProfs}/>
            </ListItem>
          </List>
          </Box>
