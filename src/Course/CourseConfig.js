            ...
            <Box component="main" sx={{ flexGrow: 1, p: 1}}>
              ...
              <List>
                ...
                <ListItem>
                  ...
                  <Typography>Add site page: </Typography>
                  <Autocomplete
                        id={"addSite"}
                        size="small"
                        options={pages}
                        sx={{ width: 300 }}
                        renderInput={(params) => <TextField {...params} label={"Add page"} />}
                  />
                  </Stack>
                </ListItem>
                ...
                <ListItem>
                  <Stack direction='row' spacing={4}>
                  <Typography>Remove site page: </Typography>
                  <Autocomplete
                        id={"addSite"}
                        size="small"
                        options={pages}
                        sx={{ width: 300 }}
                        renderInput={(params) => <TextField {...params} label={"Remove page"} />}
                  />
                  </Stack>
                </ListItem>
